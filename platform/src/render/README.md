...
During `SX05`, `platform/src/render/gl33/` becomes the first real bounded modern lane with compatibility-profile modern-context creation, shader-pipeline ownership, dynamic function loading, and deliberate degradation to `gl21`, `gl11`, and `gdi`.
During `SX06`, `platform/src/render/gl46/` becomes the real bounded premium lane with 4.6 compatibility-context creation, premium capability capture, premium-only function loading, and deliberate degradation to `gl33`, `gl21`, `gl11`, and `gdi`.
