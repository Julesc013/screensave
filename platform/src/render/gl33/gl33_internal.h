...
typedef ptrdiff_t screensave_gl33_sizeiptr;
...
#define SCREENSAVE_GL33_PRIVATE_CAP_CONTEXT_ATTRIBS 0x01000000UL
#define SCREENSAVE_GL33_PRIVATE_CAP_MODERN_CONTEXT  0x02000000UL
#define SCREENSAVE_GL33_PRIVATE_CAP_COMPAT_PROFILE  0x04000000UL
#define SCREENSAVE_GL33_PRIVATE_CAP_CONTEXT_33_PLUS 0x08000000UL
#define SCREENSAVE_GL33_PRIVATE_CAP_VBO             0x10000000UL
#define SCREENSAVE_GL33_PRIVATE_CAP_VAO             0x20000000UL
#define SCREENSAVE_GL33_PRIVATE_CAP_SHADER_PIPELINE 0x40000000UL
#define SCREENSAVE_GL33_PRIVATE_CAP_FBO             0x80000000UL

typedef struct screensave_gl33_capability_bundle_tag {
    ...
    int satisfied;
} screensave_gl33_capability_bundle;

typedef struct screensave_gl33_caps_tag {
...
} screensave_gl33_caps;

typedef struct screensave_gl33_vertex_tag {
    GLfloat x;
    GLfloat y;
    unsigned char red;
    unsigned char green;
    ...
    GLfloat u;
    GLfloat v;
} screensave_gl33_vertex;

typedef struct screensave_gl33_state_tag {
    HWND target_window;
    HDC window_dc;
    ...
    screensave_gl33_caps caps;
} screensave_gl33_state;
