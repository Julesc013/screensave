...
static const screensave_display_mapping g_renderer_status_mappings[] = {
    ...
    { "frame-open-double-buffered", "Frame open on the GL11 double-buffered lane" },
    { "frame-open-single-buffered", "Frame open on the GL11 single-buffered lane" },
    { "resized-double-buffered", "Resized on the GL11 double-buffered lane" },
    { "resized-single-buffered", "Resized on the GL11 single-buffered lane" },
    { "presented-swap", "Presented with GL11 buffer swap" },
    { "presented-flush", "Presented with GL11 flush" },
