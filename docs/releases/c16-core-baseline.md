...
| --- | --- | --- | --- |
| primary | `screensave-core-c16-baseline.zip` | `940045` bytes (`0.896` MiB) | ZIP of the frozen standalone saver line |
| secondary | `screensave-installer-c16-baseline.zip` | `1000080` bytes (`0.954` MiB) | Optional current-user installer built from the same frozen Core payload |
