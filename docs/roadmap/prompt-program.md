...
| S02 | Public platform surface planning and Win32 host groundwork | Initial public headers, platform boundary cleanup, and classic mode-routing groundwork | S01 | `platform/`, `specs/`, `docs/`, `tests/`, `validation/` | C89 baseline, ANSI host path, product isolation |
