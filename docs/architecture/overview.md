...
Post-`S15` continuation planning is tracked in `docs/roadmap/post-s15-plan.md`, and the near-term continuation path is now the post-rename checkpoint followed by all-saver `.scr` productization rather than more naming cleanup.
