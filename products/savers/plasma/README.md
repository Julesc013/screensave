...
It now ships as one unified runtime that preserves `Plasma Classic` as content identity and compatibility surface instead of as a separate execution regime.
...
It is not a general pixel-effects lab, shader showcase, or scenic 3D world product.
