...
#define PLASMA_PREMIUM_COMPONENT_DIMENSIONAL_PRESENTATION 0x00000004UL
#define PLASMA_PREMIUM_COMPONENT_HEIGHTFIELD_PRESENTATION \
...
#define PLASMA_PREMIUM_DEGRADE_DROP_DIMENSIONAL_PRESENTATION 0x00000004UL
#define PLASMA_PREMIUM_DEGRADE_DROP_HEIGHTFIELD_PRESENTATION \
    PLASMA_PREMIUM_DEGRADE_DROP_DIMENSIONAL_PRESENTATION
