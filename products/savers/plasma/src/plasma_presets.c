...
const screensave_preset_descriptor g_plasma_presets[] = {
    ...
    },
    {
        "lava_isolines",
        "Lava Isolines",
        "Warm fire-derived contour study that turns the classic lava field into explicit isolines.",
        "plasma_lava",
        SCREENSAVE_DETAIL_LEVEL_HIGH,
        1,
        0x00000A20UL
    ...
    },
    {
        "wire_glow",
        "Wire Glow",
        "Interference-driven wire contours with bounded glow-edge emphasis.",
        "oceanic_blue",
        SCREENSAVE_DETAIL_LEVEL_HIGH,
        1,
        0x00000A22UL
    },
    {
        "phosphor_topography",
        "Phosphor Topography",
        "Monochrome contour-band study with explicit phosphor-style display emulation.",
        "museum_phosphor",
        SCREENSAVE_DETAIL_LEVEL_STANDARD,
        1,
        0x00000A23UL
    },
    {
        "stipple_bands",
        "Stipple Bands",
        "Warm posterized bands filtered through a restrained halftone-stipple treatment.",
        "amber_terminal",
        SCREENSAVE_DETAIL_LEVEL_STANDARD,
        1,
        0x00000A24UL
    ...
    },
    {
        "crt_signal_bands",
        "CRT Signal Bands",
        "Amber banded study with bounded CRT-style display emulation and accent lift.",
        "amber_terminal",
        SCREENSAVE_DETAIL_LEVEL_STANDARD,
        1,
        0x00000A26UL
