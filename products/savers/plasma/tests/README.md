...
U05 through U06 extend the smoke surface so the destructive simplification pass, the retuned stable presets, the rewired experimental preset truth, and the updated BenchLab output and treatment reporting all stay aligned with the actual shipped visual grammar.
