...
static screensave_color atlas_background_color(const screensave_saver_session *session)
{
...
static screensave_color atlas_value_color(
...
)
{
    ...
    background = atlas_background_color(session);
    white_color.red = 255;
...
static void atlas_colorize_buffer(screensave_saver_session *session)
{
    int x;
    int y;
    screensave_color background;
