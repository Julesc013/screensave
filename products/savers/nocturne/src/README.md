...
Current stage: the directory contains only `nocturne_entry.c`, which contributes a no-op saver-module descriptor to the shared Series 04 host/runtime contract and no real saver visuals.
