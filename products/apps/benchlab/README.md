...
`PAW-B` starts the future Workbench shell without turning BenchLab into a second runner:

- the initial workspace model is limited to Catalog, Run, Inspect, and Compare
- the shell binds to the private `sslab` ABI v0 and generated proof registry
