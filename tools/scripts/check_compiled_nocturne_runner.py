...
def main() -> int:
    ...
    if RUNNER.exists():
        ...
        require("renderer_rgba8.h" in text, "Compiled Nocturne runner must use the shared RGBA8 renderer shim.", errors)
        require("capture.h" in text, "Compiled Nocturne runner must use the shared capture core.", errors)
