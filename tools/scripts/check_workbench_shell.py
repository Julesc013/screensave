...
def main() -> int:
    ...
    if SHELL_SOURCE.exists():
        ...
        for needle in [
            ...
            "benchlab_workbench_shell_inspect_plasma_v2_instrument",
            "benchlab_workbench_plasma_instrument_inspect",
            ...
            "original_artistic_decision",
            "validation/captures/plasma-v2/final-artistic-decision/decision.stable.toml:request-changes",
            "repair_workunit",
            "SS-PLV2-I-REPAIR-001",
            "repair_classes",
            "documentation_or_evidence_gap",
            "before_repair_evidence_refs",
            "after_repair_evidence_refs",
            "updated_spec_plan_summary",
            "updated_material_field_treatment_facts",
            "updated_proof_refs",
            "updated_visual_review_status",
            "ready-for-project-owned-re-review",
        ...
        require(
            "VisualIntent owns runtime truth" not in text,
            "Workbench shell must not claim VisualIntent owns runtime truth",
            errors,
        )
