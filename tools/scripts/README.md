...
- `plasma_lab.py` provides the bounded PX40 Plasma Lab shell for authored-substrate validation, authoring inventory, authored-object comparison, compatibility and migration reporting, pack or capture degrade inspection, and deterministic BenchLab text-capture comparison.
Type: tooling.
