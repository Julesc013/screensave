...
REQUIRED_CONTRACTS = {
    ...
    ROOT / "contracts" / "plasma_publication_prep_v1.md": [
        "Status: active publication-prep contract.",
        "Publication prep is not stable promotion.",
        "Actual publication remains a separate act.",
        "Publication prep is also not compatibility certification.",
