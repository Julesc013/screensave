...
separate result axes. Lifecycle, performance/profile, and portable v2
equivalence receipts are optional inputs; when supplied, their axes carry the
receipt status and fields instead of remaining placeholders.
...
python tools\proofbundle\proofbundle.py normalize `
  ...
  --portable-v2-equivalence out\proof\portable-v2-equivalence\equivalence.json `
