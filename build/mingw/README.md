...
For Series 06, the practical lane is `i686/`.

## Current State

Real now:

- `i686/` contains a concrete make-based lane for the same shared core, host, GDI backend, and real Nocturne product used by the VS2022 lane
