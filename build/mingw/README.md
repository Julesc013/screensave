...
For Series 08, the practical lane is `i686/`.

## Current State

Real now:

- `i686/` contains a concrete make-based lane for the same shared core, host, mandatory GDI backend, optional GL11 backend, real Nocturne saver, and real BenchLab app used by the VS2022 lane
