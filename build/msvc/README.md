...
- `vs2022/` contains the concrete modern solution and project files used to validate the build graph and output conventions.
...
Those older lanes are intentionally documentation-heavy in Series 02.
