...
This is the concrete modern MSVC lane for Series 06.
...
They define one shared static-library target and one `.scr` saver target with a shared core runtime, a real GDI backend, a real host skeleton, and the first real saver product.
